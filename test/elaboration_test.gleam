...
import gleamunison/elab_types.{SurfaceUnit, SurfaceTermDef, SInt, SVar, SMatch, SCase, SPVar}
...
pub fn typecheck_mismatch_test() {
  ...
  let bad_unit = ast.Unit(
    root: ref,
    defs: [#(ref, ast.TermDef(term: ast.Int(42), typ: ast.Builtin(ast.FloatType)))]
  )
